...
app.get('/api/seed', async (req, res) => {
  try {
    ...
    await Room.insertMany([
      ...
      { title: '2BHK Luxury - Ooty', description: 'Premium 2BHK in hill station city. Cool climate, fully furnished with modern amenities and mountain view.', price: 24000, roomType: '2BHK', location: { city: 'Ooty', address: 'Charring Cross, Ooty' }, amenities: ['WiFi', 'AC', 'Kitchen', 'Washing Machine', 'TV', 'Parking', 'Mountain View'], images: ['https://images.unsplash.com/photo-1551882547-ff40c63fe5fa?w=800'], capacity: 2, availability: true }
    ]);
